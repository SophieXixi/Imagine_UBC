...
describe("InsightFacade", function () {
	...
	describe("Add/Remove/List Dataset", function () {
		...
		// 	const left = await newfacade.listDatasets();
		// 	expect(left).to.deep.equal([
		// 		{
		// 			id: "add2",
		// 			kind: InsightDatasetKind.Sections,
		...
		// });
		// // fixxxx
		// it("crash test 2", async function () {
		// 	// Setup
		// 	await facade.addDataset("sev1", small, InsightDatasetKind.Sections);
		// 	await facade.addDataset("sev2", small, InsightDatasetKind.Sections);
		// 	// Execution
		...
		// 	});
		// });
		// it("crash test 3", async function () {
		// 	try{
		// 	// Setup
		// 		await facade.addDataset("1", small, InsightDatasetKind.Sections);
		// 		await facade.addDataset("2", small, InsightDatasetKind.Sections);
		...
		// 		const course = datasets.find((dataset) => dataset.id === "1");
		// 		expect(course).to.exist;
		// 		expect(course).to.deep.equal({
		// 			id: "1",
		// 			kind: InsightDatasetKind.Sections,
		...
		// 		});
		// 		// 2
		// 		const remove = new InsightFacade();
		// 		await remove.removeDataset("2");
		// 		const list2 = await remove.listDatasets();
		// 		expect(list2).to.have.length(2);
		// 		await remove.addDataset("1", small, InsightDatasetKind.Sections);
		// 		expect.fail("should have been rejected!");
		// 	} catch (err){
		// 		expect(err).to.be.instanceOf(InsightError);
		// 	}
